...
$plugins = array(
    ...
    array(
    "name" => __( "Better Robots.txt optimization – Website indexing, traffic, ranking & SEO Booster + Woocommerce", 'better-robots-txt' ),
    "desc" => __( "Better Robots.txt is an all in one SEO robots.txt plugin, it creates a virtual robots.txt including your XML sitemaps (Yoast or else) to boost your website ranking on search engines.", 'better-robots-txt' ),
...
<div class="rt-recs rt-containter">
...
foreach ( $plugins as $plugin ) {
    ...
    ?>
                        ...
                        <a href="<?php 
    echo  $plugin['link'] ;
    ?>" class="rt-link-btn" target="_blank">
                            <?php 
...
echo  __( 'Upgrade to PRO version to UNLOCK 12 additional awesome plugins recommendations for SEO & Conversion performance', 'better-robots-txt' ) ;
?></h2>
        </div>
