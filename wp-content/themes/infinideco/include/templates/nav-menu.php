<?php 
	...
	$header_variant = ( (is_wp_home() && empty($page_name)) || is_singular('exposant')) ? 'v2' : 'v1';
?>
	...
	<div class="container">
			...
			<?php }elseif ($header_variant == 'v2'){ ?>
				<div class="navbar_elem_wrapper">
					<a class="navbar-brand" href="<?php echo $home_url; ?>">
						<img src="<?php echo STYLESHEET_DIR_URI . '/assets/images-v3/main-logo-v2-'.PROJECT_NAME.'.svg?v=' . CACHE_VERSION_CDN; ?>" class="main-logo img-responsive" alt="<?php echo apply_filters('alt_logo_header', get_bloginfo('name'));?>" />
					</a>
					<div class="menu-site hidden-xs hidden-sm">
