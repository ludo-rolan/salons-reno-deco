<?php  
	...
	$exposant_slugs = ['amenagement', 'mobilier', 'decoration', 'espace-decouverte'];
...
<div id="content"class="col-xs-12 col-md-8">
	...
	<p class="bold">Découvrez les exposants du Salon Art&Déco qui se tient du 14 au 17 octobre 2021 à Paris à la Grande Halle de la Villette.</p>
	<p class="bold">Vous souhaitez dès à présent prendre rendez-vous avec les exposants sur le salon ?</p>
