<?php
		...
		$content_diapo.= "<span class='btn-navs _left' data-index='0' data-count='" . $attachments_count . "'></span>
		<span class='btn-navs _right' data-index='1' data-count='" . $attachments_count . "'></span>";
