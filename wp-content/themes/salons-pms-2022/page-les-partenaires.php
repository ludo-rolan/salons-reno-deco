...
<div id="content"class="col-xs-12 col-md-8">
    <div class="page-content page-listing">

        <div class="intro" style="text-align:center; margin:30px 0;">
            <p>
                <?php echo get_option('text_page_exposant' , '') ?>
            </p>
            <div class="search-form-container">
                <div class="search-form">
                    <input type="text" id="search-exposants" placeholder="Rechercher un partenaire" />
        ...
        <?php 
            ...
            foreach ($exposants as $exposant) {
                ...
                include(locate_template("include/templates/partenaire-card.php"));
                $count++;
            }
        ?>
        </div>        
