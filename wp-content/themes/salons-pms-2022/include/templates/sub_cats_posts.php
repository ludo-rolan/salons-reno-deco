...
if( !empty($sub_categories) ){
	foreach ($sub_categories as $categorie) {
		$cat_meta  = get_option('category_'.$categorie->term_id);
			...
			<div class="bloc-posts" data-hash-target="#<?php echo $categorie->slug; ?>">
				<div class="bloc_rubrique_head">
					<h2 class="default-title">
						<a href="<?php echo $categorie_link; ?>" style="<?php echo  (isset($cat_color)) ? "color:$cat_color":"";?>"><?php echo $categorie->name; ?></a>
					</h2>
				...
				?>
				<a href="<?php echo $categorie_link; ?>" class="btn-lire-plus">Voir tous les articles</a>
				</div>
			</div> <!-- .bloc_exposants -->
			<?php
		}
