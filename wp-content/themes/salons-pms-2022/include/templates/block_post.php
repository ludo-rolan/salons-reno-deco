...
$post_img 	= '';
$target_blank = (isset($is_communique_presse) && $is_communique_presse) ? 'target="_blank"' : '';
...
<div class="post_img">
	<a href="javascript:void(0);" title="<?php echo $post->post_title ;?>" data-href="<?php echo $post_link; ?>"  target="<?php echo $target_blank; ?>" >
	...
	<a class="info_cat" target="<?php echo $target_blank; ?>"  href="<?php echo $cat_lien; ?>" style="<?php echo (isset($cat_color)) ? "color:$cat_color":"";?>"><?php echo $cat->name; ?></a>
	
</div>
<div class="post_caption">
	<div class="post_title">	
		<a title="<?php echo $titre;?>" href="<?php echo $post_link; ?>" target="<?php echo $target_blank; ?>"  >
