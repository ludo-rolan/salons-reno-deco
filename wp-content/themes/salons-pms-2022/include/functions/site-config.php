...
$site_config = array(
	...
	"google_analytics_id" => "UA-200769843-1",
    "test_google_analytics_id" => "UA-52051220-32",
    'integration_ga_reworld' => true,
	
	"ga_api_id" => 'ga:246401666',
	"test_ga_api_id" => 'ga:245865487',
		...
		'sources' => array( 
			'NL_MTRA' => array( 
					"labels"=>array(
						...
						"Je souhaite recevoir la newsletter Paris Mobility Show" => array("key"=>"OPTIN_MTRA","datejoin" => "OPTIN_MTRA_DATEJOIN","dateunjoin" => "OPTIN_MTRA_DATEUNJOIN","value"=>1),
						"Je souhaite recevoir les communications des partenaires de Paris Mobility Show" => array("key"=>"OPTIN_PART","value"=>1),
	...
	'cheetah_nl' => array(
		...
		'categorie_cheetah' => 'mondial-auto',
		'ref_id_rmp'   	=>	array('mondial Paris Edito' => 21),
		'footer_nl_info' => array(
			'msg'   => "Ne ratez plus rien de l'actualité de Mondial Paris",
			'class' => 'pms',
			'optin' => array('optin_edito'),
		),
	),
	// Social config
    "facebook_url" => 'https://www.facebook.com/lemondialdelautoparis/',
    "instagram_url"=> 'https://www.instagram.com/mondialdelautoparis/',
    "twitter_url" => 'https://twitter.com/mondialdelauto',
	"linkedin" => 'https://www.linkedin.com/company/27011638/',
	"youtube_link"=>'https://www.youtube.com/channel/UCwh0yc9zj-toj0a6pBpoDQA',
	...
	'auto_pinterest_publish_param' => array( 
							'auto_pinterest_publish_access_token' => '',
							'auto_pinterest_publish_board' => ''
						),
	"IS_READ_MORE" => "yes",
	...
	'favicon32' => STYLESHEET_DIR_URI. '/assets/images-v3/favicon_32.png?v=3',
	'favicon48' => STYLESHEET_DIR_URI . '/assets/images-v3/favicon_48.png?v=3',
	'favicon64' => STYLESHEET_DIR_URI . '/assets/images-v3/favicon_64.png?v=3',
	'favicon128' => STYLESHEET_DIR_URI . '/assets/images-v3/favicon_128.png?v=3',
	...
	'google_play_url'=>'',
	'not_reverse'=>true,
	'title_home' => __('Paris Mobility Show : Paris Mobility Show' ,  'reworldmedia' ),	
	'thumb_full_width_diapo' => true,
	'number_posts_diaporama'=> 6,
	
	'type_diapo' => '1',
	'link_visu_diapo' => true,
	'bloginfo_name' => 'Paris Mobility Show',
	...
	'blogname'=>'Paris Mobility Show',
	'blogdescription'=>"	",
	'thumb_author' => array(90,90),
	"has_folder"=>true,
	'newsletter_qualif' => 'Inscription newsletter Paris Mobility Show',
	...
	'change_outbrain_links_to_prod'=> 'www.mondial.paris',
	...
	'newsletter_qualif_url' => '/inscription-newsletter',
	'nav_bar_plus' => true,
	...
	'has_exposant'=>true,
	'theme_colors'=>array(
		'#a045fc','#01db5c','#fd3c1d','#00beff','#a5a5a5',
	)
);
...
$site_config_js['nl_automatique'] = array( "folder_id" => 29935, "mail_domaine_id" => 24, 'ma_category' => "MTRA", "segment_id" => array('edito'=> 19),'form_name' => 'Paris Mobility Show', 'reply_name'=> 'Relation Client Paris Mobility Show', 'form_addr' => 'info@news.maison-travaux.fr' );
