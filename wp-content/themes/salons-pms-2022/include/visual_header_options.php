...
if (is_admin()):
    ...
    class Visual_header_Options {
        ...
        function visual_header_admin() {
			...
			if( isset($_POST['txt_btn_reservation_fr'])) {
                update_option('txt_btn_reservation_fr',  $_POST['txt_btn_reservation_fr'], false);
            }
            $txt_btn_reservation_fr = esc_attr( get_option('txt_btn_reservation_fr' , ''));
            
			if( isset($_POST['url_btn_reservation_fr'])) {
                update_option('url_btn_reservation_fr',  $_POST['url_btn_reservation_fr'], false);
            }
            $url_btn_reservation_fr = esc_attr( get_option('url_btn_reservation_fr' , ''));
            
			if( isset($_POST['txt_btn_reservation_en'])) {
                update_option('txt_btn_reservation_en',  $_POST['txt_btn_reservation_en'], false);
            }
            $txt_btn_reservation_en = esc_attr( get_option('txt_btn_reservation_en' , ''));
            
			if( isset($_POST['url_btn_reservation_en'])) {
                update_option('url_btn_reservation_en',  $_POST['url_btn_reservation_en'], false);
            }
			...
			<form id="addtag" method="post" class="validate">
				<table class="form-table" >
					...
					<tr valign="top">
						<th scope="row" >
							<label for="txt_btn_reservation_fr"><?php _e('Text du button de réservation en FR', REWORLDMEDIA_TERMS); ?></label>
						</th>
						<td>
							<input type="text" name="txt_btn_reservation_fr" id="txt_btn_reservation_fr"  value="<?php echo $txt_btn_reservation_fr; ?>" class="regular-text"/>
							<p class="description">
								<?php _e('Le Text en FR a afficher dans button de reservation dans HP ', REWORLDMEDIA_TERMS); ?>
							</p>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row" >
							<label for="url_btn_reservation_fr"><?php _e('Url du button de réservation FR', REWORLDMEDIA_TERMS); ?></label>
						</th>
						<td>
							<input type="text" name="url_btn_reservation_fr" id="url_btn_reservation_fr"  value="<?php echo $url_btn_reservation_fr; ?>" class="regular-text"/>
							<p class="description">
								<?php _e('Url de la page de reservation en FR', REWORLDMEDIA_TERMS); ?>
							</p>
						</td>
					</tr>
					...
					<tr valign="top">
						<th scope="row" >
							<label for="txt_btn_reservation_en"><?php _e('Text du button de réservation en Anglais', REWORLDMEDIA_TERMS); ?></label>
						</th>
						<td>
							<input type="text" name="txt_btn_reservation_en" id="txt_btn_reservation_en"  value="<?php echo $txt_btn_reservation_en; ?>" class="regular-text"/>
							<p class="description">
								<?php _e('Le Text en Anglais a afficher dans button de reservation dans HP  ', REWORLDMEDIA_TERMS); ?>
							</p>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row" >
							<label for="url_btn_reservation_en"><?php _e('Url du button de réservation Anglais', REWORLDMEDIA_TERMS); ?></label>
						</th>
						<td>
							<input type="text" name="url_btn_reservation_en" id="url_btn_reservation_en"  value="<?php echo $url_btn_reservation_en; ?>" class="regular-text"/>
							<p class="description">
								<?php _e('Url de la page de reservation en EN ', REWORLDMEDIA_TERMS); ?>
							</p>
						</td>
					</tr>
